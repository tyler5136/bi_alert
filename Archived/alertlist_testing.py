...
def get_alert_from_alertlist(session, camera):
    ...
    try:
        ...
        alert_clip = {
            "path": selected_alert.get("path", ""),  # This is the ALERT segment, not the full clip
...
def export_clip(session, path, msec):
    ...
    startms = msec - export_duration if msec > export_duration else 0
